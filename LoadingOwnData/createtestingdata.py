import pickle
pickle_in = open("../resources/X.pickle", "rb")
X_full_data = pickle.load(pickle_in)


pickle_in = open("../resources/y.pickle", "rb")
...
pickle_out = open("../resources/X_training.pickle", "wb")
pickle.dump(X_training_data, pickle_out)
pickle_out.close()

pickle_out = open("../resources/y_training.pickle", "wb")
